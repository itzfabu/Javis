...
## Corpus Check
- Corpus is ~25,125 words - fits in a single context window. You may not need a graph.

## Summary
- 155 nodes · 174 edges · 37 communities (22 shown, 15 thin omitted)
- Extraction: 83% EXTRACTED · 15% INFERRED · 2% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.87)
- Token cost: 254,349 input · 0 output
...
9. `Daily Brief 2026-07-27` - 6 edges
10. `Project: Jarvis-as-a-Service Launch` - 5 edges

## Surprising Connections (you probably didn't know these)
- `#jarvis-business Tag` --conceptually_related_to--> `Project: Jarvis-as-a-Service Launch`  [AMBIGUOUS]
  TASKS.md → knowledge/PROJECTS.md
...
Cohesion: 0.31
Nodes (12): Business Analyst Agent, Coder Agent, Debugger Agent, Planner Agent, Project Manager Agent, Researcher Agent, Webdesigner Agent, Writer Agent (+4 more)

### Community 3 - "Orb Flask Backend (app.py)"
Cohesion: 0.26
Nodes (10): before_request, add_history(), background_backup(), chat(), check_origin(), get_open_tasks(), index(), run_claude() (+2 more)

### Community 4 - "Streamer HUD Market Research"
Cohesion: 0.20
...
### Community 6 - "Monetization Goal & Task Tags"
Cohesion: 0.43
Nodes (7): Goal: Monetize the Jarvis System, Project: Jarvis-as-a-Service Launch, Project: Streamer HUD Widget, TASKS.md Task List, #jarvis-as-a-service Tag, #jarvis-business Tag, #streamer-hud Tag
...
- `#jarvis-business Tag` → `Project: Jarvis-as-a-Service Launch`  [AMBIGUOUS]
  TASKS.md · relation: conceptually_related_to
...
## Knowledge Gaps
- **53 isolated node(s):** `Tasks Format Convention`, `Jarvis Persona (Sachlich-neutral, effizient)`, `Startup Routine (Greeting + Weather/Tasks Summary)`, `Berlin Pride Terror Attack`, `Strait of Hormuz Mine Explosion` (+48 more)
...
- **What is the exact relationship between `#jarvis-business Tag` and `Project: Jarvis-as-a-Service Launch`?**
...
- **Why does `Jarvis-as-a-Service Pricing Research` connect `Business Planning & Pricing Notes` to `Streamer HUD Market Research`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Daily News Brief Cloud Routine` connect `Daily News Brief` to `Jarvis System Documentation (README)`?**
